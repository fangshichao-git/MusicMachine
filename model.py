...
class simpleRNN(Model):
    ...
    def __init__(self, name, inp_dim, hid_dim, out_dim, olayer_type='softmax'):
    ...
    def train(self, data, epoch=500 ,lrate=0.1):
    ...
    def fantasize(self, init_music, round):
        ...
        intro_frac=1/2
        hm1=self.initHiddenByMusic(init_music,len_frac=intro_frac)
        inp=[init_music[int(len(init_music)*intro_frac)+1]]
        fantasyDiary=[]
